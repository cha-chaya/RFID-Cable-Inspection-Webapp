...
<html>
	...
	<body>
		...
		<ul class="topnav">
			...
			<li><a class="active" href="cable_data.php"> <i class="fas fa-book"></i> Cable Data</a></li>
		...
		<div class="container-fluid">
            <div class="row">
                <h2>Cable Data Table</h2>
            </div>
		<!-- Search/add data form -->
		<form class="form-inline" action='search_data.php' method='post'>
  			<div >
					...
					<button type="button" name="add" id="add" data-toggle="modal" data-target="#add_data_Modal" class="btn btn-warning"> <i class="fas fa-edit"></i>&nbsp;Registration</button>
        	</div> <br/>
 		</form>
            <div class="row">
                <table class="table table-striped table-bordered">
                  ...
                  <tbody>
                  <?php
                   include 'cable_db.php';
                   $pdo = Database::connect();
                   $sql = 'SELECT * FROM table_cable_data ORDER BY name ASC';
                   foreach ($pdo->query($sql) as $row) {
					...
					echo '<td>'. $row['note'] . '</td>';
					echo '<td><a class="btn btn-success" href="edit_cable_data.php?id='.$row['id'].'">Edit</a>';
					echo ' ';
					echo '<a class="btn btn-danger" href="del_cable_data.php?id='.$row['id'].'">Delete</a>';
					echo '</td>';
					echo '</tr>';
                   }
                   Database::disconnect();
				...
				<div class="modal-content">  
						...
						<div class="modal-body"> <br/><br/>
							...
							<div class="row" >							
								...
								<form action="add_db_cable.php" method="post" name="frmExcelImport" id="frmExcelImport" enctype="multipart/form-data" >
								<div><tr>
									<td>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;</td>
						...
						<form class="form-horizontal" action="insert_db_cable.php" method="post" >
